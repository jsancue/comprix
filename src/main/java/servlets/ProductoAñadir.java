...
/**
 * Servlet implementation class ProductosAñadir
 */
@WebServlet("/ProductoAñadir")
public class ProductoAñadir extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (isMultiPart) {
				...
				String query = "INSERT INTO \"comprix\".producto (nombre,categoria,detalles,imagen,precio) VALUES(?,?,?,?,?)";
