...
public class EnviarEmail {
	...
	public void enviarEMail() {
		...
		// link will be send
		final String email = "comprixnorep@outlook.es";
		final String password = "comprix2022";

		Properties propiedades = new Properties();

		propiedades.setProperty("mail.smtp.host", "smtp-mail.outlook.com");
		...
		try {
			...
			mensaje.setContent("<!DOCTYPE html>\n" + "<html>\n" + "	<head>\n" + "		<title>\n"
					...
					+ "								</h1><img height=\"150\" src=\"https://raw.githubusercontent.com/jsancue/almacen/75e3e71c233bcfbe06d00d3a636ff58091f10cae/verificado.svg\" style=\"display: block; border: 0px\" width=\"150\">\n"
					+ "							</td>\n" + "						</tr>\n"
					+ "					</table>\n" + "				</td>\n" + "			</tr>\n"
					+ "			<tr>\n"
					...
					+ "														<a href=\"https://localhost:8443/ActivarCuenta?key1="
					+ userEmail + "&key2=" + myHash
