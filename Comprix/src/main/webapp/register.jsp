...
<body>
	...
	<section class="form-container">
		<form action="Registerv2" enctype="multipart/form-data" method="post">
			...
			<div class="form-grupo">
				<input accept="image/jpg, image/jpeg, image/png" class="caja" id="imagen" name="imagen" required="" type="file">
			</div>
